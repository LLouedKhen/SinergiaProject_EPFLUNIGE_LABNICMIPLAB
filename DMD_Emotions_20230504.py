...
#                    if diff > 0:
#                        rel = em + '_' +  thisMov + '_' + thisSub + '_' + str(diff)
#                        checkTheseTS.append(rel)
#                        for d in range(diff):
#                            x = np.zeros(data2.shape[1])
...
#                        continue
    ...
    dfA = pd.DataFrame(dcp.A) 
    dfZ = pd.DataFrame(dcp.Z) 
    dfEigIDX = pd.DataFrame(dcp.eig_idx)
    dfEigVal = pd.DataFrame(dcp.eig_val)
    dfEigVec = pd.DataFrame(dcp.eig_vec)
                       
                       
                       
    dfAll =dcp.df
    dfAll.to_csv('DMD_' + em + '_' + str(today) + '.csv')
    dfA.to_csv('A_' + em + '_' + str(today) + '.csv')
    dfZ.to_csv('Z_' + em + '_' + str(today) + '.csv')    
    dfEigIDX.to_csv('EigIdx_' + em + '_' + str(today) + '.csv')
    dfEigVal.to_csv('EigVal_' + em + '_' + str(today) + '.csv')
    dfEigVec.to_csv('EigVec_' + em + '_' + str(today) + '.csv')             

                  
    os.chdir('/home/loued/Figures')
    import matplotlib.pyplot as plt
    fig0 = plt.plot(dfAll['damping_time'])


    # Add labels
    plt.title('Plot of decreasing Δ for ' + em )
    plt.xlabel('Mode Number ')
    plt.ylabel('Δ  (s)')
    plt.savefig('DampingTimes_' + em + '_AllMovies' + str(today) + '.png')
    plt.close()
...
#    fig2a.update_annotations(align='right')
    ...
    fig2a.update_layout(title = 'BrainSchaefer_' + em + '_AllMovies     T =' + str(round(dfAll.period[1],3)) + 's; Δ = ' + str(round(dfAll.damping_time[1],3)))
    fig2a.write_image('BrainSchaefer_' + em + '_AllMovies' + str(today) + 'Mode1.png')
...
##    fig2b.update_annotations(align='right')
    ...
    fig2b.write_image('BrainSchaefer_' + em + '_AllMovies' + str(today) +  'Mode2.png')
    
#    fig2c = Brain(dcp.df, 3, dcp.atlas.coords_2d).figure(colormap = 'Spectral')
#    fig2c.show(renderer="png")
#    fig2c.update_layout(title = 'BrainSchaefer_' + em + '  _AllMovies' )
#    fig2c.write_image('BrainSchaefer_' + em + '  _AllMovies' + str(today) +  'Mode3.png')
#    
#    fig2d = Brain(dcp.df, 4, dcp.atlas.coords_2d).figure(colormap = 'Spectral')
#    fig2d.show(renderer="png")
#    fig2d.update_layout(title = 'BrainSchaefer_' + em + '  _AllMovies' )
#    fig2d.write_image('BrainSchaefer_' + em + '  _AllMovies' + str(today) +  'Mode4.png')
#    
#    fig2d = Brain(dcp.df, 5, dcp.atlas.coords_2d).figure(colormap = 'Spectral')
#    fig2d.show(renderer="png")
#    fig2d.update_layout(title = 'BrainSchaefer_' + em + '  _AllMovies' )
#    fig2d.write_image('BrainSchaefer_' + em + '  _AllMovies' + str(today) +  'Mode5.png')
#    
#    fig2e = Brain(dcp.df, 6, dcp.atlas.coords_2d).figure(colormap = 'Spectral')
#    fig2e.show(renderer="png")
#    fig2e.update_layout(title = 'BrainSchaefer_' + em + '  _AllMovies' )
#    fig2e.write_image('BrainSchaefer_' + em + '  _AllMovies' + str(today) +  'Mode6.png')
#    
#    fig2f = Brain(dcp.df, 7, dcp.atlas.coords_2d).figure(colormap = 'Spectral')
#    fig2f.show(renderer="png")
#    fig2f.update_layout(title = 'BrainSchaefer_' + em + '  _AllMovies' )
#    fig2f.write_image('BrainSchaefer_' + em + '  _AllMovies' + str(today) +  'Mode7.png')
#    
#    fig2g = Brain(dcp.df, 8, dcp.atlas.coords_2d).figure(colormap = 'Spectral')
#    fig2g.show(renderer="png")
#    fig2g.update_layout(title = 'BrainSchaefer_' + em + '  _AllMovies' )
#    fig2g.write_image('BrainSchaefer_' + em + '  _AllMovies' + str(today) +  'Mode8.png')
#    
#    fig2h = Brain(dcp.df, 9, dcp.atlas.coords_2d).figure(colormap = 'Spectral')
#    fig2h.show(renderer="png")
#    fig2h.update_layout(title = 'BrainSchaefer_' + em + '  _AllMovies' )
#    fig2h.write_image('BrainSchaefer_' + em + '  _AllMovies' + str(today) +  'Mode9.png')
#    
#    fig2i = Brain(dcp.df, 10, dcp.atlas.coords_2d).figure(colormap = 'Spectral')
#    fig2i.show(renderer="png")
#    fig2i.update_layout(title = 'BrainSchaefer_' + em + '  _AllMovies' )
#    fig2i.write_image('BrainSchaefer_' + em + '  _AllMovies' + str(today) + 'Mode10.png')
#    
