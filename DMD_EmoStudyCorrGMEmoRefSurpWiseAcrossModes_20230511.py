...
refFile = 'truncDMD_Surprise_GrandMeanSortedDT.csv'
refModes = []
...
for f in range (0,len(files)):
    ...
    if 'Surprise' in thisFile:
        ...
        corrThisDF.to_csv('CorrMatSurpriseto_' + em + '_30ModesMu'  + '.csv')
        os.chdir(dmdPath)
...
os.chdir(dmdPath)
maxCorrDFa.to_csv('MaxCorr30Modes_byEmotoSurprise.csv')