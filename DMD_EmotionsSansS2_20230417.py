...
for em in Emotions:
    ...
    dfEig = pd.concat([pd.DataFrame(dcp.eig_idx), pd.DataFrame(dcp.eig_val),pd.DataFrame(dcp.eig_vec)], axis =1)
    ...
    dfEig.to_csv('Eig_' + em + '  _' + str(today) + '.csv')
