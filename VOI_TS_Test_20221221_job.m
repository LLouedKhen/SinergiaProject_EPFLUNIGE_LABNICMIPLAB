%-----------------------------------------------------------------------
% Job saved on 21-Dec-2022 14:29:57 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
matlabbatch{1}.spm.util.voi.roi{2}.mask.image = {'/media/miplab-nas2/Data2/Movies_Emo/Leyla/ImagingData/HCPex_v1.0/HCPex_v1.0/ROIs/HCPex_2mm_10.nii,1'};
...
matlabbatch{2}.cfg_basicio.var_ops.cfg_save_vars.outdir = {'/media/miplab-nas2/Data2/Movies_Emo/Leyla/ImagingData/sub-S01/FullModel__AfterTheRain_AllPmod_Ortho/AfterTheRain_Schaefer400_BetaSeries'};
