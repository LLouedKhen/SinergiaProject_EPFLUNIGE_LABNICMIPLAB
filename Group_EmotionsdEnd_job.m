...
mkdir SecondLevel_Emotions_dEnd/
cd SecondLevel_Emotions_dEnd/
for em = 1:length(Emotions) 
    ...
    thisDir = fullfile(imgBetaPath,'SecondLevel_Emotions_dEnd', thisEm);

    files =  dir(fullfile(imgBetaPath, '**', [thisEm,'*','dEnd'], 'con_0001.nii'));
