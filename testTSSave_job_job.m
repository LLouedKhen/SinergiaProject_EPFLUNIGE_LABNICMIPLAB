%-----------------------------------------------------------------------
% Job saved on 22-Nov-2022 14:30:01 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
matlabbatch{2}.cfg_basicio.var_ops.cfg_save_vars.name = 'ROI_conName_TS';
...
matlabbatch{2}.cfg_basicio.var_ops.cfg_save_vars.saveasstruct = false;
