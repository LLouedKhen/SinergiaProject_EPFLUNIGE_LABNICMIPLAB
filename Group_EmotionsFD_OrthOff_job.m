...
GAnDir = 'SecondLevel_EmotionsFD_OrthFree/';
    if ~exist(GAnDir, 'dir')
        mkdir(GAnDir);
    end

cd SecondLevel_EmotionsFD_OrthFree/
for em = 1:length(Emotions) 
    ...
    files =  dir(fullfile(imgBetaPath, '**', ['FullModel__','*','_AllPmod_FD_OrthFree'], ['con_00',emNum,'.nii']));
