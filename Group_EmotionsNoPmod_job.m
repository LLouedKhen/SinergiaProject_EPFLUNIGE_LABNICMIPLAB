...
mkdir SecondLevel_Emotions_NoPmod/
cd SecondLevel_Emotions_NoPmod/
for em = 1:length(Emotions) 
    ...
    thisDir = fullfile(imgBetaPath,'SecondLevel_Emotions_NoPmod', thisEm);

    files =  dir(fullfile(imgBetaPath, '**', [thisEm,'*','NoPmod'], 'con_0001.nii'));
