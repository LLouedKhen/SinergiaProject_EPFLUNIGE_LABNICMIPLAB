clear; clc;
outPath = '/media/miplab-nas2/Data2/Movies_Emo/Leyla/DMD_Data/MovieEmotions/SubjectWise/TruncDMD/CorrEmoWise/MunkResOutEmo';
...
Ems = extractBetween(file, startP, endP);
Em = Ems{1};
% thisSub = SubEms(1:7);
% thisEm = SubEms(8:end);
...
cd(outPath)
fileN = strcat('MunkRes_', Em, '_toSurprise.csv');
