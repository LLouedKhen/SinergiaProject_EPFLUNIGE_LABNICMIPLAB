...
for em in Emotions:
    ...
    os.chdir(dmdPath)
    thisMovie_CortParc400.to_csv('BetaSeries_' + em + '_4S_' + str(today) + '.csv')
    ...
    dfAll =dcp.df
    dfAll.to_csv('DMDVal4S_' + em +'.csv')
    
    os.chdir('/home/loued/Figures')
    fig1 = Radar(dcp.df, dcp.atlas).figure(imag = True, amount = 6)
    fig1.show(renderer="png")
    fig1.update_layout(title = 'Radar_' + em + '_4S_AllMovies' )
    fig1.write_image('Radar_' + em + '_4S_AllMovies'  + str(today) + '.png')
...
#    fig2a.update_annotations(align='right')
    ...
    fig2a.update_layout(title = 'BrainSchaefer_' + em + '_4S_AllMovies     T =' + str(round(dfAll.period[1],3)) + '; Δ = ' + str(round(dfAll.damping_time[1],3)))
    fig2a.write_image('BrainGlasser_' + em + '_4S_AllMovies' + str(today) + 'Mode1.png')
...
##    fig2b.update_annotations(align='right')
    fig2b.update_layout(title = 'BrainSchaefer_' + em + '_4S_AllMovies      T =' + str(round(dfAll.period[2],3)) + '; Δ = ' + str(round(dfAll.damping_time[2],3)))
    fig2b.write_image('BrainGlasser_' + em + '_4S_AllMovies' + str(today) +  'Mode2.png')
    
    fig2c = Brain(dcp.df, 3, dcp.atlas.coords_2d).figure(colormap = 'Spectral')
    fig2c.show(renderer="png")
    fig2c.update_layout(title = 'BrainGlasser_' + em + '_4S_AllMovies' )
    fig2c.write_image('BrainGlasser_' + em + '_4S_AllMovies' + str(today) +  'Mode3.png')
    
#    fig2d = Brain(dcp.df, 4, dcp.atlas.coords_2d).figure(colormap = 'Spectral')
#    fig2d.show(renderer="png")
#    fig2d.update_layout(title = 'BrainGlasser_' + em + '_4S_AllMovies' )
#    fig2d.write_image('BrainGlasser_' + em + '_4S_AllMovies' + str(today) +  'Mode4.png')
#    
#    fig2d = Brain(dcp.df, 5, dcp.atlas.coords_2d).figure(colormap = 'Spectral')
#    fig2d.show(renderer="png")
#    fig2d.update_layout(title = 'BrainGlasser_' + em + '_4S_AllMovies' )
#    fig2d.write_image('BrainGlasser_' + em + '_4S_AllMovies' + str(today) +  'Mode5.png')
#    
#    fig2e = Brain(dcp.df, 6, dcp.atlas.coords_2d).figure(colormap = 'Spectral')
#    fig2e.show(renderer="png")
#    fig2e.update_layout(title = 'BrainGlasser_' + em + '_4S_AllMovies' )
#    fig2e.write_image('BrainGlasser_' + em + '_4S_AllMovies' + str(today) +  'Mode6.png')
#    
#    fig2f = Brain(dcp.df, 7, dcp.atlas.coords_2d).figure(colormap = 'Spectral')
#    fig2f.show(renderer="png")
#    fig2f.update_layout(title = 'BrainGlasser_' + em + '_4S_AllMovies' )
#    fig2f.write_image('BrainGlasser_' + em + '_4S_AllMovies' + str(today) +  'Mode7.png')
#    
#    fig2g = Brain(dcp.df, 8, dcp.atlas.coords_2d).figure(colormap = 'Spectral')
#    fig2g.show(renderer="png")
#    fig2g.update_layout(title = 'BrainGlasser_' + em + '_4S_AllMovies' )
#    fig2g.write_image('BrainGlasser_' + em + '_4S_AllMovies' + str(today) +  'Mode8.png')
#    
#    fig2h = Brain(dcp.df, 9, dcp.atlas.coords_2d).figure(colormap = 'Spectral')
#    fig2h.show(renderer="png")
#    fig2h.update_layout(title = 'BrainGlasser_' + em + '_4S_AllMovies' )
#    fig2h.write_image('BrainGlasser_' + em + '_4S_AllMovies' + str(today) +  'Mode9.png')
#    
#    fig2i = Brain(dcp.df, 10, dcp.atlas.coords_2d).figure(colormap = 'Spectral')
#    fig2i.show(renderer="png")
#    fig2i.update_layout(title = 'BrainGlasser_' + em + '_4S_AllMovies' )
#    fig2i.write_image('BrainGlasser_' + em + '_4S_AllMovies' + str(today) + 'Mode10.png')
    
    fig3 = Spectre(dcp.df, ['Group 1']).figure()
    fig3.show(renderer="png")
    fig3.update_layout(title = 'Spectre_' + em + '_4S_AllMovies' )
    fig3.write_image('Spectre_' + em + '_4S_AllMovies' + str(today) + '.png')
    
    fig4 = TimePlot(dcp.df).figure(amount = 3)
    fig4.update_layout(title = 'Timeseries_' + em + '_4S_AllMovies' )
    fig4.show(renderer="png")
    fig4.write_image('TimePlot_' + em + '_4S_AllMovies'  + str(today) + '.png')
    os.chdir(dmdPath)