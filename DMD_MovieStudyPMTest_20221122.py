...
testDir = '/media/miplab-nas2/Data2/Movies_Emo/Leyla/ImagingData/sub-S01/FullModel__AfterTheRain_AllPmod_Ortho'
os.chdir(testDir)
files= glob.glob('VOI_HCPex_2mm*.mat')
data3 = []
for f  in files:
    mat = scipy.io.loadmat(f)
    a = list(mat.values())
    thisData =a[4]
    data3.append(thisData)
                  
dcp = Decomposition(data3, filenames ='/home/loued/.local/lib/python3.7/site-packages/nidmd/tests/data/HCPex_2mm_vol.mat' )
